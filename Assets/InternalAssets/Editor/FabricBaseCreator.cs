...
{
    private const string PresetsFolder = "Assets/InternalAssets/Editor/Presets/FabricPresets";

    
    private TextAsset AbstractFabricCreator;
    
    
    [MenuItem("Custom Tools/Import Fabric")]
    ...
    {
        string scriptPath = Path.Combine("Assets", "InternalAssets", "Scripts", "State Machine","AbstractFabricCreator.cs");
